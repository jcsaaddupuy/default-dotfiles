...
for s = 1, screen.count() do
    quakeconsole[s] = lain.util.quake({ app = terminal, height = 0.5})
end
-- }}}
...
-- }}}
--
local tag_web = tags[1][1]
local tag_media = tags[1][4]
local tag_torrents = tags[1][7]
...
-- Calendar
lain.widgets.calendar:attach(mytextclock, { font_size = 22 })
...
globalkeys = awful.util.table.join(
    ...
    -- Screensaver
    awful.key({ modkey, "Control" }, "l", function () awful.util.spawn("/usr/bin/sxlock") end)
)
...
awful.rules.rules = {
    ...
    { rule = { class = "Firefox" }, properties = { tag = tag_web } },
    { rule = { instance = "plugin-container" }, properties = { tag = tag_web } },

    { rule = { class = "Deluge" }, properties = { tag = tag_torrents } },

	{ rule = { class = "Gmpc" }, properties = { tag = tag_media } },
	{ rule = { class = "Ario" }, properties = { tag = tag_media } },
    { rule = { class = "Caja" }, properties = { tag = tags[1][5] } },
...
--{{ Random wallpaper
local wp_path = "/home/jc/Images/backgrounds/"

local wp_random = require "wp_random"
wp_random.start({timeout = 10 * 60, directory = wp_path, exts={".png", ".jpg", ".tbn"}})
--}}
--
--
